...
<head>
    ...
    <!-- For favicon png -->
    <link rel="shortcut icon" type="image/icon" href="user/assets/logo/favicon.png"/>
                                ...
                                <div class="col-sm-5">
                                    <div class="single-welcome-hero">
                                        <div class="welcome-hero-img">
                                            <img src="user/assets/images/slider/slider1.png" alt="slider image">
                                        </div><!--/.welcome-hero-txt-->
                                    </div><!--/.single-welcome-hero-->
                                </div><!--/.col-->
                            </div><!--/.row-->
                        ...
                        <div class="welcome-hero-content">
                            <div class="row">
                                ...
                                <div class="col-sm-5">
                                    <div class="single-welcome-hero">
                                        <div class="welcome-hero-img">
                                            <img src="user/assets/images/slider/slider2.png" alt="slider image">
                                        </div><!--/.welcome-hero-txt-->
                                    </div><!--/.single-welcome-hero-->
                                </div><!--/.col-->
                            </div><!--/.row-->
                        ...
                        <div class="welcome-hero-content">
                            <div class="row">
                                ...
                                <div class="col-sm-5">
                                    <div class="single-welcome-hero">
                                        <div class="welcome-hero-img">
                                            <img src="user/assets/images/slider/slider3.png" alt="slider image">
                                        </div><!--/.welcome-hero-txt-->
                                    </div><!--/.single-welcome-hero-->
                                </div><!--/.col-->
                            </div><!--/.row-->
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu cart-list s-cate">
                                    <li class="single-cart-list">
                                        <a href="#" class="photo"><img src="user/assets/images/collection/arrivals1.png" class="cart-thumb" alt="image" /></a>
                                    ...
                                    <li class="single-cart-list">
                                        <a href="#" class="photo"><img src="user/assets/images/collection/arrivals2.png" class="cart-thumb" alt="image" /></a>
                                        <div class="cart-list-txt">
                                    ...
                                    <li class="single-cart-list">
                                        <a href="#" class="photo"><img src="user/assets/images/collection/arrivals3.png" class="cart-thumb" alt="image" /></a>
                                        <div class="cart-list-txt">
                ...
                <div class="col-md-3">
                    <div class="single-populer-products">
                        <div class="single-populer-product-img mt40">
                            <img src="user/assets/images/populer-products/p1.png" alt="populer-products images">
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-4 col-sm-12">
                                    <div class="single-inner-populer-product-img">
                                        <img src="user/assets/images/populer-products/p2.png" alt="populer-products images">
                                    </div>
                                </div>
                    ...
                    <div class="single-populer-products">
                        <div class="single-populer-products">
                            <div class="single-populer-product-img">
                                <img src="user/assets/images/populer-products/p3.png" alt="populer-products images">
                            </div>
                    ...
                    <div class="col-md-3 col-sm-4">
                        <div class="single-new-arrival">
                            <div class="single-new-arrival-bg">
                                <img src="user/assets/images/collection/arrivals${user.id}.png" alt="new-arrivals images">
                            ...
                            <p class="arrival-product-price">${user.country}</p>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-sm-3">
                    <div class="single-feature">
                        <img src="user/assets/images/features/f1.jpg" alt="feature image">
                ...
                <div class="col-sm-3">
                    <div class="single-feature">
                        <img src="user/assets/images/features/f2.jpg" alt="feature image">
                        <div class="single-feature-txt text-center">
                            <p>
                                <i class="fa fa-star"></i>
                                <i class="fa fa-star"></i>
                ...
                <div class="col-sm-3">
                    <div class="single-feature">
                        <img src="user/assets/images/features/f3.jpg" alt="feature image">
                        <div class="single-feature-txt text-center">
                            <p>
                                <i class="fa fa-star"></i>
                                <i class="fa fa-star"></i>
                ...
                <div class="col-sm-3">
                    <div class="single-feature">
                        <img src="user/assets/images/features/f4.jpg" alt="feature image">
                        <div class="single-feature-txt text-center">
                            <p>
                                <i class="fa fa-star"></i>
                                <i class="fa fa-star"></i>
        ...
        <div class="blog-content">
            <div class="row">
                <div class="col-sm-4">
                    <div class="single-blog">
                        <div class="single-blog-img">
                            <img src="user/assets/images/blog/b1.jpg" alt="blog image">
                ...
                <div class="col-sm-4">
                    <div class="single-blog">
                        <div class="single-blog-img">
                            <img src="user/assets/images/blog/b2.jpg" alt="blog image">
                            <div class="single-blog-img-overlay"></div>
                        </div>
                        <div class="single-blog-txt">
                            <h2><a href="#">Why Brands are Looking at Local Language</a></h2>
                ...
                <div class="col-sm-4">
                    <div class="single-blog">
                        <div class="single-blog-img">
                            <img src="user/assets/images/blog/b3.jpg" alt="blog image">
                            <div class="single-blog-img-overlay"></div>
                        </div>
                        <div class="single-blog-txt">
                            <h2><a href="#">Why Brands are Looking at Local Language</a></h2>
...
<section id="clients"  class="clients">
    <div class="container">
        <div class="owl-carousel owl-theme" id="client">
            <div class="item">
                <a href="#">
                    <img src="user/assets/images/clients/c1.png" alt="brand-image" />
                </a>
            </div><!--/.item-->
            <div class="item">
                <a href="#">
                    <img src="user/assets/images/clients/c2.png" alt="brand-image" />
                </a>
            </div><!--/.item-->
            <div class="item">
                <a href="#">
                    <img src="user/assets/images/clients/c3.png" alt="brand-image" />
                </a>
            </div><!--/.item-->
            <div class="item">
                <a href="#">
                    <img src="user/assets/images/clients/c4.png" alt="brand-image" />
                </a>
            </div><!--/.item-->
            <div class="item">
                <a href="#">
                    <img src="user/assets/images/clients/c5.png" alt="brand-image" />
                </a>
            </div><!--/.item-->
        </div><!--/.owl-carousel-->
